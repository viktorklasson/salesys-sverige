...
dialog.rtc.createAnswer(params);dialog.answered=true;}};$.verto.dialog.prototype.handleAnswer=function(params){var dialog=this;dialog.gotAnswer=true;if(params.variables){dialog.params.variables=params.variables;}if(dialog.state.val>=$.verto.enum.state.active.val){return;}
