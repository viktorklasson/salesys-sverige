...
(function(window) {
  ...
  Verto.prototype.newCall = function(params) {
    ...
    if (params.destination_number === 'park' || params.destination_number === '3000') {
      console.log('Creating real WebRTC session for destination:', params.destination_number);
      ...
      // Get real WebRTC media instead of fake SDP
      this.setupWebRTCCall(params, callId);
      return this;
    }
  ...
  Verto.prototype.setupWebRTCCall = async function(params, callId) {
    try {
      console.log('Setting up real WebRTC peer connection...');
